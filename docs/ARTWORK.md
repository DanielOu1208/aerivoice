...
repository on August 31, 2026, under Daniel Ou's direction. They adapt Daniel
Ou's existing Aeri brand language: a near-black rounded tile and pearlescent
pink handwritten `Aeri` wordmark. The AeriVoice mark scales down the wordmark
and replaces the dot above the `i` with a microphone.
...
retains its original timing, with no audio, at 800 × 600 and 12 frames per second.
It loops continuously. Palette quantization uses 128 colors and Bayer dithering;
the GIF is approximately 2.1 MB. The source recording remains outside the repo.
